              ...
              error ? (
                ...
                article.summary && (
                  <div className="flex flex-col gap3">
                    ...
                    <div >
                      <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-2 px-4 mt-2 right-0 rounded-full" onClick={()=> handleCopy(article.summary, setCopied2)}>
                        Copy Summary
                      </button>
                    </div>
                  </div>
