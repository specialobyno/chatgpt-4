                ...
                article.summary && (
                  <div className="flex flex-col gap3">
                    ...
                    <div className="flex  justify-end p-2 w-full" >
                      <button type="button" className="bg-gradient-to-r from-orange-400 via-red-500 to-pink-500 hover:bg-blue-700 right-0 text-white text-sm font-bold py-2 px-4 rounded-full" onClick={()=> handleCopy(article.summary, setCopied2)}>
                        Copy Summary
                      </button>
                    </div>
                  </div>
